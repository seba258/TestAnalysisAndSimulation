...
filename_off = "Data/O3.24h.JAN.OFF.nc4"
filename_on = "Data/O3.24h.JAN.ON.nc4"

DS_off = xr.open_dataset(filename_off)  # extract data set from netCFD file
da_off = DS_off.SpeciesConc_O3  # retrieve data array containing 24h average PM25 concentrations (21 days, 72 levels)
